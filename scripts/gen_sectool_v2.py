...
# CARD1 SD
# CARD1: 引脚竖排，电源向左水平拉（避免穿过其他引脚）
pin_lbl("CARD1", "1", "SD_CS", dx=-10)
pin_lbl("CARD1", "2", "SD_MOSI", dx=-10)
p3 = P("CARD1", "3")
w(p3[0], p3[1], p3[0]-10.16, p3[1])
w(p3[0]-10.16, p3[1], p3[0]-10.16, p3[1]+5.08)
pwr("GND", p3[0]-10.16, p3[1]+5.08, 180)
p4 = P("CARD1", "4")
w(p4[0], p4[1], p4[0]-12.7, p4[1])
w(p4[0]-12.7, p4[1], p4[0]-12.7, p4[1]-5.08)
pwr("VCC", p4[0]-12.7, p4[1]-5.08)
pin_lbl("CARD1", "5", "SD_CLK", dx=-10)
p6 = P("CARD1", "6")
w(p6[0], p6[1], p6[0]-10.16, p6[1])
w(p6[0]-10.16, p6[1], p6[0]-10.16, p6[1]+5.08)
pwr("GND", p6[0]-10.16, p6[1]+5.08, 180)
